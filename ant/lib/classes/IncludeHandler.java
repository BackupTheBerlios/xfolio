 ...
 * @version CVS $Id: IncludeHandler.java,v 1.1 2004/11/18 12:01:06 glorieux Exp $
 */

public class IncludeHandler implements ContentHandler, LexicalHandler {
     ...
     * Constructor
     */
    public IncludeHandler (ContentHandler contentHandler, LexicalHandler lexicalHandler) {
     ...
     * Constructor
     */
    public IncludeHandler (ContentHandler contentHandler) {
        this.contentHandler = contentHandler;
