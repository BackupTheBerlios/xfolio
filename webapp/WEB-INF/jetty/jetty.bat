...
set CP=org.mortbay.jetty.jar;javax.servlet.jar;jasper-runtime.jar;jasper-compiler.jar;xalan-2.6.0.jar;xercesImpl-2.6.2.jar;xml-apis.jar
...
set CMD= %CMD% -Dorg.xml.sax.parser=org.apache.xerces.parsers.SAXParser org.mortbay.jetty.Server %CONF% main.xml
